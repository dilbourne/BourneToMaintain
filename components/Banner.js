...
const Banner = (props) => (
    <div className="container w-auto mx-auto rounded-sm">
        <div className="flex flex-col justify-around items-center w-full h-80" style={{backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(images/unsplash-banner.jpg)", backgroundSize: "100% 100%", backgroundPosition:"center", backgroundRepeat: "no-repeat"}}>
