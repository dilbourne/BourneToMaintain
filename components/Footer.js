...
const Footer = () => (
    <footer>
        <div className="h-64 w-auto mx-auto container flex flex-col items-center justify-center bg-green-500 py-8 rounded-sm">
            ...
            <p className="pb-4 font-bold uppercase text-xs text-white">Contact Us</p>
            ...
            <p className="text-white pt-4 pb-1">&copy; Bourne To Maintain, 2020. All rights reserved.</p>
